...
public class CalendarTimeLineMenu extends UserviewMenu implements PluginWebSupport {
    public final static String LABEL = "Calendar Timeline";

    @Override
    public String getClassName() {
        return CalendarTimeLineMenu.class.getName();
    }
